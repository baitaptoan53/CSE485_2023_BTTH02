                ...
                <div class="card-body">
                    ...
                    <div class="auth-brand text-center text-lg-left">
                        <a href="index.html" class="logo-dark">
                            <span><img src="./assets/images/logo.png" alt="" height="24"></span>
                    ...
                    <!-- form -->
                    <form action="./index.php?controller=logup" method="post">
                        ...
                        <label for="password" class="text-nowrap mt-1 mr-2">Bạn là:</label>
                        <select class="form-select" aria-label="Default select example" name = "seclectLogup">
                                <option value="0">Người dùng</option>
                                <option selected value="1">Người đăng bài</option>
                        </select>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group mb-0 text-center">
                            <button class="btn btn-primary btn-block" type="submit" name="submitLogup"><i
                    ...
                    <footer class="footer footer-alt">
                        <p class="text-muted">Bạn đã có tài khoản? <a href="./index.php?controller=login" class="text-muted ml-1"><b>Đăng
                                    nhập</b></a></p>
                    </footer>
