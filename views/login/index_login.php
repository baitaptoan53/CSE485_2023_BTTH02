            ...
            <div class="card-body">
                ...
                <form action="./index.php?controller=login" method="post">
                    ...
                    <div class="form-group mb-0 text-center">
                        <button class="btn btn-primary btn-block" type="submit" name ="submitLogin"><i class="mdi mdi-login"></i> Log In </button>
                    </div>
                    <!-- social-->
                ...
                <footer class="footer footer-alt">
                    <p class="text-muted">Don't have an account? <a href="./index.php?controller=logup" class="text-muted ml-1"><b>Sign Up</b></a></p>
                </footer>
